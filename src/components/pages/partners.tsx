        ...
        <div className="flex flex-col justify-center space-y-4">
          <div className="mx-3 space-y-2 lg:space-y-3 max-w-md md:max-w-2xl lg:max-w-3xl">
            ...
            <p className="leading-normal text-xl text-muted-foreground">
              With Full Stack Starter Kit, harness diverse tech capabilities in
              one setup, reducing complexity and enhancing developer
              productivity.
            </p>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <Button
              variant="ghost"
              className="flex justify-center items-center p-4 h-40 rounded-lg"
            >
              <svg
            ...
            <Button
              variant="outline"
              className="flex justify-center items-center h-40 rounded-lg"
            >
              Convex
            </Button>
            <Button
